...
describe('Login', () => {
  ...
  it('Tes Generate Modul', () => {
    ...
    // cy.get('.dropDown-content-grup > .css-58rwkm-control > .css-1khjq34 > .css-19bb58m', timeout).click();
    // cy.get('[id^="react-select-"][id$="-option-1"]').click();  //(1) - (sekian) pilihan opsi grup kompetensi

    // // pilih dirkom :
    // cy.get('.dropDown-content-nama > .css-58rwkm-control > .css-1khjq34 > .css-19bb58m', timeout).click();
    ...
    // cy.get(':nth-child(1) > .Dropdown-root > .Dropdown-control').click();
    // cy.get('.Dropdown-menu > .is-selected').click();
    // cy.get('.dropdown_search > .css-58rwkm-control > .css-1khjq34 > .css-19bb58m').click();
