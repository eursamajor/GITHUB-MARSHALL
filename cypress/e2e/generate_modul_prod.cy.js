...
describe('Login', () => {
  ...
  it('Tes Generate Modul', () => {
    ...
    //ambil screenshot
    cy.screenshot(`generatemodul1_dev-${new Date().toISOString().replace(/[:.]/g, '-')}`);
    //tombol generate :
   ...
   cy.get('#topik3', timeout).clear().type('Machine learning for NLP in daily life');
    ...
    //ambil screenshot
    cy.screenshot(`generatemodul2_dev-${new Date().toISOString().replace(/[:.]/g, '-')}`);
    //tombol generate :
    cy.get('.modulBut', timeout).click();
    cy.wait(5000);
    cy.get('.generateBaru_but', timeout).click();
    ...
    //ambil screenshot
    cy.screenshot(`generatemodul3_dev-${new Date().toISOString().replace(/[:.]/g, '-')}`);
    //tombol generate :
    cy.get('.modulBut', timeout).click();
    cy.wait(5000);
    cy.get('.generateBaru_but', timeout).click();
    ...
    //ambil screenshot
    cy.screenshot(`generatemodul4_dev-${new Date().toISOString().replace(/[:.]/g, '-')}`);
    //tombol generate :
    cy.get('.modulBut', timeout).click();
    cy.wait(5000);
    cy.get('.generateBaru_but', timeout).click();
    ...
    //ambil screenshot
    cy.screenshot(`generatemodul5_dev-${new Date().toISOString().replace(/[:.]/g, '-')}`);
    //tombol generate :
    cy.get('.modulBut', timeout).click();
    cy.wait(5000);
    cy.get('.generateBaru_but', timeout).click();
